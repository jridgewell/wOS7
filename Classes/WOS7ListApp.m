...
#define UIColorFromRGB(rgbValue) [UIColor colorWithRed:((CGFloat)((rgbValue & 0xFF0000) >> 16))/255 green:((CGFloat)((rgbValue & 0xFF00) >> 8))/255 blue:((CGFloat)(rgbValue & 0xFF))/255 alpha:1]
